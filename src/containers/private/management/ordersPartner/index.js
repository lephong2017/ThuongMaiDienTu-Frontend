...
import {reqLoadDataPaging, reqSearchOrders, reqCountData,
     reqFindOrders, reqDeleteOrders, reqAddOrders, reqUpdateOrders} from 'redux/ordersPartner/actions';
...
class OrderManagement extends Component{
    ...
    showDrawerEdit=(id)=>{ 
        ...
        this.props.handleFindOrder(id, accesstoken);
...
const mapStateToProps = state => {
    return {
        order: state.ordersPartner,
        itemOrders: state.itemOrdersPartner,
        numberOrder: state.numberDataOrdersPartner
    }
}
